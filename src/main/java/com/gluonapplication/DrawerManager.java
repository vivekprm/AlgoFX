...
public class DrawerManager {
    ...
    public static void buildDrawer(MobileApplication app) {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("AlgoFX",
                "Algorithms Visual Representation",
        ...
        final Item secondaryItem = new ViewItem("Algorithms", MaterialDesignIcon.DASHBOARD.graphic(), SECONDARY_VIEW);
